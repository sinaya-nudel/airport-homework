...
public class FlightDriver {
    public static void main(String[] args) {
        ...
        secondFlight.setFlightDuration(444);
        secondFlight.setNoOfPassengers(-44);
        ...
        System.out.println ("Were 200 passengers added successfully to the first flight? "+firstFlight.addPassengers(150));
        ...
        System.out.println("full?" + secondFlight.getIsFull());
        System.out.println(secondFlight.getDeparture());
        System.out.println(secondFlight.getFlightDuration());
